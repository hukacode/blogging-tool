...
export function activate(context: vscode.ExtensionContext) {
  ...
  let changeUpdatedDataCommand = vscode.commands.registerCommand('garden-helper.changeUpdatedDate', () => {
  ...
  let addTwoSpacesAtTheEndSentenceCommand = vscode.commands.registerCommand('garden-helper.addTwoSpacesAtTheEndSentence', () => {
